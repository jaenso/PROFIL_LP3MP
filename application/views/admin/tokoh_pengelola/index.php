<div class="col-lg-12 grid-margin stretch-card">
	<div class="card">
		<div class="card-body">
			...
			<a href="<?= base_url();?>tokoh_pengelola/tambah" class="btn btn-primary"
            ...
            foreach ($tokoh as $tkh) : ?>
					<tbody>
						<tr>
							...
							<td>
								<a
									href="<?= base_url();?>tokoh_pengelola/edit/<?= $tkh->id_tokoh;?>"
									class="btn btn-warning"
									><i class="mdi mdi-tooltip-edit"></i
								></a>
								<a
									href="<?= base_url();?>tokoh_pengelola/hapus/<?= $tkh->id_tokoh;?>"
