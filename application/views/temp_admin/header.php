...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?= base_url(); ?>asset_admin/plugins/fontawesome-free/css/all.min.css" /><!-- Ionicons -->
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>asset_admin/dist/css/admin_css" />
  <!-- overlayScrollbars -->
