...
class tokoh_pengelola extends CI_Controller {
	...
	public function index()
	{
        ...
        $config['base_url'] = 'http://localhost/ci3-sql/tokoh_pengelola/index';
        $config['num_links'] = 5;
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == FALSE)
        {
            $this->load->view('template_admin/header', $data);
			$this->load->view('template_admin/sidebar', $data);
			$this->load->view('admin/tokoh_pengelola/tambah');
			$this->load->view('template_admin/footer');
        }
        else
        {
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                $this->load->view('template_admin/header', $data);
                $this->load->view('template_admin/sidebar', $data);
                $this->load->view('admin/tokoh_pengelola/tambah', $error);
                $this->load->view('template_admin/footer');
            } else {
        ...
        public function edit($idk)
    {
        ...
        if ($this->form_validation->run() == FALSE)
        {
            $this->load->view('template_admin/header', $data);
			$this->load->view('template_admin/sidebar', $data);
			$this->load->view('admin/tokoh_pengelola/edit', $data);
			$this->load->view('template_admin/footer');
        }
        else
        {
